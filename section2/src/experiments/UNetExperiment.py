...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER:
            # dimension 0 represents the batch size
            # dimension 1 represents the channels: 
            #   channels 0: probability to be background,
            #   channel 1: probability to be anterior hippocampus (class1),
            #   channel 2: probability to be posterior hippocampus (class 2)
            # dimensions 2 and 3 represent spatial coordinates
